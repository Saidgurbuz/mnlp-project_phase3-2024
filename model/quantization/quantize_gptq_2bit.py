...
model_gptq.push_to_hub(
 repo_id="StefanKrsteski/Phi-3-mini-4k-instruct-DPO-EPFL-GPTQ-2bit",
)

tokenizer.push_to_hub("StefanKrsteski/Phi-3-mini-4k-instruct-DPO-EPFL-GPTQ-2bit")
